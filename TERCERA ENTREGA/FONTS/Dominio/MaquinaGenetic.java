...
/**
 * Clase de la maquina con algoritmo genetico.
 * @author Roger Marco
 *
 */
public class MaquinaGenetic implements Maquina {
	 ...
	 * @param numeroColores Numero de colores de la partida.
	 * @param maxSteps Steps maximos.
	 * @param longitudCodigo Longitud del codigo.
	 */
