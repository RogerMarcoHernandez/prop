...
public class PerfilTest {
	...
	public void testCreacionPerfil() {
		...
		assertTrue(perfil.obtenContrasena().equals("contrasenyaEjemplo") && perfil.obtenNombreUsuario().equals("nombreEjemplo") 
				&& perfil.obtenEstadisticas()!=null && perfil.obtenPartidasGanadas()==0 && perfil.obtenPartidasAcabadas()==0
				&& perfil.obtenPartidasJugadas()==0 && perfil.obtenPartidasPerdidas()==0 && perfil.obtenNumeroLogrosSuperados()==0);
	}
